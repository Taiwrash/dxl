    ...
    return <>
        ...
        <div className="hero h-screen md:flex md:mt-10" >
            <div className="flex items-center justify-center text-center md:text-left flex-col text-white bg-[#40435C] h-full opacity-40 md:opacity-100 md:w-1/2 md:bg-[#EEEBEB]">
                ...
                <p className="text-center text-white px-10 md:px-16 text-lg md:text-[#646975] md:text-left">{text}</p>
                <a onClick={handleMore} className="text-[#00D1FF]" >Read {more ? "Less" : "More"}  </a>
            </div>
            <div className=" hidden md:flex ">
                <img src={header.header.heroImage} alt="hero" className="" />
            </div>
        </div>
        <div className="bg-white w-11/12 md:w-9/12 md:right-40 md:ml-60 mx-auto shadow-lg relative bottom-[100px] pt-20 p-10">
